...
import { SearcherProfile, Sex, StudyLevel } from '@/types/SearcherProfile';
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setProfile(prev => ({
                  ...
                  financialInfo: {
                    ...prev.financialInfo!,
                    financialStatus: e.target.value as "Student" | "Working Student" | "Scholarship" | "Other"
                  }
                }))}
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-cercooffro-primary focus:ring focus:ring-cercooffro-primary/50"
              >
...
export default SearcherProfileForm;